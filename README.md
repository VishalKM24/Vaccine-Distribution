...
- CreateVaccine- Vaccine Id, Vaccine Quantity, Vaccine owner address

**prerequisites**

- msg.sender should be admin
- Vaccine owner should be verified user

**Output**

 mark Vaccine Id, Status as Pending, Vaccine Quantity, Vaccine owner address

**3.Approve the new Vaccine.**

**parameters**

- approveVaccine- Vaccine Id
...
mark Vaccine Satus as Approved

**4.Reject the new Vaccine.**

**parameters**

- rejectVaccine- Vaccine Id
...
Mark Vaccine Satus as Rejected

**5. Request Change of Ownership.**

**parameters**

- changeOwnership- Vaccine Id, new owner address
...
mark Vaccine Ownership change request

**6.Approve change in Onwership.**

**parameters**

- ApproveChangeOwnership- Vaccine Id
...
**7.Change the price of the Vaccine.**

**parameters**

- changeQuantity- Vaccine Id, new Vaccine Quantity
...
change Vaccine Quantity

**8.Get the Vaccine details.**

**parameters**

- GetVaccineDetails- Vaccine Id

**Output**

Status, Vaccine Quantity, Vaccine owner address
